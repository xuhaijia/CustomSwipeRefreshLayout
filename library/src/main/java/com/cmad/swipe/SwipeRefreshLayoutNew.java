...
//    private boolean mIsBootom = true;
     ...
     * @param context
     */
    public SwipeRefreshLayoutNew(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayoutNew(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void addDefaultHeadView(Context context) {
        mHeadView = LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical_new,null);
    ...
    private void ensureTarget() {
        Log.d("SwipeRefreshLayout", "getChildCount():" + getChildCount());
